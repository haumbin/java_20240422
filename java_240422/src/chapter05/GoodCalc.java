...
abstract class Calculator{/*추상 클래스 선언(추상메소드는 없어도 됨)*/
//	public int add(int a, int b) {return 1;}
//	public abstract int add(int a, int b) {return 1;} //추상 메소드는 구현시 오류가 남
...
//public abstract class GoodCalc extends Calculator{//추상클래스는 구현이 불필요하다
